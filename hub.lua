...
Sub.Position = UDim2.new(0,0,0.23,0)
...
Box.Parent = Main
Box.Size = UDim2.new(0.82,0,0,50)
Box.Position = UDim2.new(0.09,0,0.45,0)
...
BoxStroke.Color = Color3.fromRGB(170, 0, 255)
...
-- COULEURS : fond NOIR, écritures et bords VIOLET
local C_BG      = Color3.fromRGB(8, 8, 12)        -- Noir profond
local C_PANEL   = Color3.fromRGB(12, 10, 18)      -- Noir panel
local C_ROW     = Color3.fromRGB(25, 20, 45)      -- Violet clair ligne
local C_ROW_HOV = Color3.fromRGB(45, 35, 75)      -- Violet plus clair hover
local C_BORDER  = Color3.fromRGB(100, 40, 180)    -- Violet bordure
local C_BORDER2 = Color3.fromRGB(120, 60, 200)    -- Violet clair bordure
local C_HEADER  = Color3.fromRGB(10, 8, 16)       -- Noir header
local C_ACCENT  = Color3.fromRGB(180, 120, 255)   -- Violet clair accent
local C_ACCENT2 = Color3.fromRGB(200, 150, 255)   -- Violet très clair accent2
local C_DIM     = Color3.fromRGB(90, 45, 150)     -- Violet dim
local C_WHITE   = Color3.fromRGB(255, 255, 255)   -- Blanc pur
local C_ON_BG   = Color3.fromRGB(80, 35, 150)     -- Violet on
local C_OFF_BG  = Color3.fromRGB(25, 20, 40)      -- Noir off
local C_KEY_BG  = Color3.fromRGB(35, 28, 60)      -- Violet foncé key
...
-- FOV 120 avec gestion des connexions
...
-- TP DOWN de la source SIUUUU HUB (qui fonctionne parfaitement)
...
titleLbl.Size=UDim2.new(0,200,0,22); titleLbl.Position=UDim2.new(0,20,0,11)
titleLbl.BackgroundTransparency=1; titleLbl.Text="Npaz LHub"
titleLbl.TextColor3=C_WHITE; titleLbl.Font=Enum.Font.GothamBlack; titleLbl.TextSize=18
...
closeBtn.BackgroundColor3=Color3.fromRGB(30,25,45); closeBtn.BorderSizePixel=0
...
closeBtn.MouseEnter:Connect(function()
	TweenService:Create(closeBtn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(100,40,160),TextColor3=C_WHITE}):Play()
	TweenService:Create(closeBtnStroke,TweenInfo.new(0.12),{Color=Color3.fromRGB(160,80,220)}):Play()
end)
closeBtn.MouseLeave:Connect(function()
	TweenService:Create(closeBtn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(30,25,45),TextColor3=C_ACCENT}):Play()
...
mini.Name="NpazMini"; mini.Size=UDim2.new(0,110,0,30); mini.Position=UDim2.new(0,20,0,20)
...
RunService.RenderStepped:Connect(function()
	...
	if not State.autoPlayEnabled then
		...
		elseif State.lagSpeedToggled then
			spd = State.lagSpeed
		else
